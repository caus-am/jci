% Copyright (c) 2014-2020, Antti Hyttinen, Frederick Eberhardt, Matti Järvisalo, Joris M. Mooij, Patrick Forré
% All rights reserved.
%
...
% ---
%
%%% Modified version of cyclic ASD algorithm:
%%%
%%% - added three rules to conditioning operator to implement sigma separation
